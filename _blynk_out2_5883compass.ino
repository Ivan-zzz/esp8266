...
char auth[] = "your device pass ID for blYnk webserver"; // access token/id from blynk website
char ssid[] = "WIFI source";  // any internet source
...
void setup() {
  ...
  compass.init();
  compass.setCalibration(-356, 1030, -33, 1341, -1190, 0);// calibrated values for my 5883 module. Calibration MATTERS! Comment this line if you cant do it.
compass.setMode(0x01, 0x04, 0x00, 0x80); // if you need to setup 5883 module working regime.
// compass.setMode(MODE, ODR, RNG, OSR) // if you need to setup 5883 module working regime.
/*
